...
int main(){
    ...
    if(skew==0) cout<<"Normal distribution, ";
    else if(skew<0) cout<<"Distribution is assymetrical, points in negative direction (left skewed), ";
    else if(skew>0) cout<<"Distribution is assymetrical, points in positive direction (right skewed), ";
    else cout<<"Ummm wtf";

    if(kurtos==3) cout<<"mesokurtic.";
    else if(kurtos<3) cout<<"platykurtic. ";
    else if(kurtos>3) cout<<"leptopkurtic.";
    else cout<<"Ummm wtf";
    cout<<endl<<endl;
system("PAUSE");
return 0;
